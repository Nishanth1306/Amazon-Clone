...
const Login = () => {
    ...
    const handleLogin = () => {
      ...
      axios
        ...
        .catch((error) => {
          Alert.alert("Login Error", "Invaliddd Email");
          console.log(error);
        });
    };
    return (
            ...
            <KeyboardAvoidingView>
                ...
                <View style={{ marginTop: 70 }}>
                    <View style={{ flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: "#D0D0D0", paddingVertical: 5, borderRadius: 5, marginTop: 30 }}>
                        <MaterialCommunityIcons style={{ marginLeft: 8 }} name="email" size={24} color="black" />
                        <TextInput
                            value={email}
                            onChangeText={setEmail}
                            style={{ color: "grey", marginVertical: 7, width: 300, fontSize: 16 }}
                ...
                <Pressable onPress={handleLogin} style={{ width: 200, backgroundColor: "#febe10", borderRadius: 6, marginLeft: "auto", marginRight: "auto", padding: 15 }}>
                    <Text style={{ textAlign: "center", fontSize: 18, fontWeight: "bold" }}>Login</Text>
                </Pressable>
